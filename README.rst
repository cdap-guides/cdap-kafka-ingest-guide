...
Cask Data Application Platform (`CDAP <https://cask.co>`__).
...
The instructions are repeated below for your convenience and assume you have downloaded the binary distribution::
  ...
  # Start Kafka Server: Ignore any java.net.BindException exceptions thrown (since there could be port conflict with CDAP Local Sandbox's ZooKeeper Server)
